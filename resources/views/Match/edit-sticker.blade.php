...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="col-md-8">
                <form role="form" method="post" enctype="multipart/form-data" id="tray-icon-form" action='{{url('sticker')}}/{{$stickers['id']}}'>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="category" id="category" required>
                                @foreach($categories as $key=>$val)
                                    @if($val['id']==$stickers['category_id'])
                            ...
                            <div class="form-group">
                                ...
                                <img id="team1_logo_upload" src="{{Storage::url('sticker/1x/').$stickers['sticker']}}"
